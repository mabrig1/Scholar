  ...
  return (
    <main className="admin-shell">
      <header className="admin-topbar">
        <div>
          <span className="badge">DOCFORGE • MABRIG RESEARCHER PRO</span>
          <h1>Document Formatting Studio</h1>
          <p>Turn academic text into a clean, downloadable Microsoft Word document with professional formatting controls.</p>
        </div>
        <div className="actions">
          <a className="btn secondary" href="/">Researcher Pro</a>
      ...
      <section className="admin-converter-layout">
        <article className="card admin-converter-card">
          ...
          <form action="/api/format/word" method="post" target="_blank">
        ...
        <aside className="card conversion-business-card">
          <span className="poster-kicker">DOCFORGE CAPABILITIES</span>
          <h2>Professional Document Output</h2>
          <p>Prepare structured Word documents for academic, institutional and publishing workflows.</p>
          <div className="conversion-feature-list">
            ...
            <div><strong>Download control</strong><span>The generated Word file downloads directly to your device.</span></div>
