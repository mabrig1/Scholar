...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const paths = ["", "/workspace", "/chapter-four", "/formatter", "/publishing-agent", "/free-journals", "/scopus-journals", "/academic-support", "/academic-printing", "/pricing", "/trust", "/privacy", "/terms", "/track"];
