    ...
    <main className="workspace-shell">
      ...
      <section className="workspace-hero">
        <div className="container">
          ...
          <p className="lead">Enter the research details once. Researcher Pro carries them into literature review, data analysis, integrity screening, formatting, publishing intelligence and professional assistance.</p>
        </div>
      </section>
      ...
      <section className="section container workspace-layout">
        ...
        <aside className="workspace-side">
          ...
          <article className="card workspace-next-card">
            ...
            <button type="button" onClick={() => continueTo("/research-agent")}><strong>Run an agentic research mission</strong><small>Coordinate discovery, evidence verification, synthesis, critique and the next specialist handoff.</small></button>
