...
const plans = [
  {
    ...
    features: ["Private manuscript workspace", "Chapter Four analysis and Word export", "Journal pathway directories", "Publishing readiness preview", "Format-only Word conversion", "No account required"],
    href: "/workspace",
    action: "Start free",
  },
  {
    ...
    featured: true,
    features: ["Human document review", "Data-analysis review and interpretation", "Rewriting and clarity editing", "Institution-specific formatting", "Citation and reference cleanup", "Word/PDF output and tracked delivery"],
